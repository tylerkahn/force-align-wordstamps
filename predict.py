...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        transcript: str = Input(description="Transcript text", default=None),
        language: str = Input(description="Language", default="en"),
        show_probabilities: bool = Input(
            description="Show probabilities", default=False
        ),
    ) -> dict:
        ...
        if transcript is None:
            ...
            # Perform alignment
            aligned_result = self.model.align(str(audio_file), transcript, language)
            aligned_words = self.model.align_words(
                str(audio_file), aligned_result, language
            )
